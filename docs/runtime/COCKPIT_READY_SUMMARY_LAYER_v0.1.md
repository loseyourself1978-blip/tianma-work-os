...
For the current LDD pilot, the summary layer uses the newest validated active checkpoint. As of the post-close defense reconciliation update, that checkpoint is `2026-06-09T08:28:00+08:00`. Older records remain available as history, but they should not override the latest active state.
